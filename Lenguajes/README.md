## Kotlin Program to demonstrate operations between languages

<p>In this program we demonstrate the operations between Languages represented by string variables and their implementation in Kotlin. All of the operations were made without the usage of an external API.</p>
